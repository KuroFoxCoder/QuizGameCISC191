...
public class KOF extends Topic {
    ...
    public Question[] getQuestions() {
        ...
        try
        {
        	questionScanner = new Scanner(new File("KofQuestions.txt"));
        	optionScanner = new Scanner(new File("KofOptions.txt"));
        	answerScanner = new Scanner(new File("KofAnswers.txt"));
